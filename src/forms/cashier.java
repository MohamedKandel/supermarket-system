...
public class cashier extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setFont(new java.awt.Font("Chaparral Pro Light", 1, 20)); // NOI18N
    ...
    private void set() {
        ...
        b.setName(txt_user.getText());
        b.setPass(txt_pass.getText());
    ...
    private void search() {
        String txtSer;
        String query = "SELECT ID,Username,Statuss FROM `users` WHERE ";
